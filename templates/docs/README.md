...
See (prompts/README.md) for detailed selection guide.
...
This starter kit includes infrastructure templates for common architectures. See (docs/tech-stack.md) for detailed technology choices and (infrastructure/) for implementation.
...
See (CONTRIBUTING.md) for guidelines on contributing to this starter kit.
...
This starter kit is provided as-is for use with Claude Code development projects. Customize the license as needed for your specific project.