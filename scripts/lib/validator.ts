...
export class Validator {
  ...
  static validateProjectConfig(config: Partial<ProjectConfig>): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  static validateEnvironmentVariables(envVars: Record<string, string>): { valid: boolean; missing: string[] } {
  ...
  static validateFilePermissions(filePath: string): Promise<boolean> {
