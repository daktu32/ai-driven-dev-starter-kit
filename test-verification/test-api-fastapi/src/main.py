"""
test-api-fastapi - FastAPI Application
...
app = FastAPI(
    ...
    description="test-api-fastapi - Generated by Claude Code Dev Starter Kit",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def root():
    ...
    return HealthResponse(
        status="success",
        message="test-api-fastapi API is running!",
        project="test-api-fastapi"
    )
