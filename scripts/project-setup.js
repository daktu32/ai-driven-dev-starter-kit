...
class ProjectSetup {
        ...
        const questions = [
            {
                ...
                filter: (input) => Validator.sanitizeProjectName(input),
            },
            {
                type: 'input',
                name: 'description',
                ...
                filter: (input) => Validator.sanitizeDescription(input),
            },
            {
                type: 'input',
                name: 'repositoryUrl',
                ...
                default: (answers) => `https://github.com/your-username/${Validator.generateSlugFromName(answers.projectName)}`,
            },
        ];
    ...
    async generateCursorRules(config) {
