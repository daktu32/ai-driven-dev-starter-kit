/**
 * Example Resource for template-var-test
...
export class ExampleResourceProvider {
  private resources: ExampleResource[] = [
    {
      ...
      description: 'First example resource for template-var-test',
      mimeType: 'text/plain',
    },
  ];
  ...
  async getResource(uri: string): Promise<string> {
    ...
    return `Content of ${resource.name}: This is example data from template-var-test`;
  }
}