# Claude Code 開発スターターキットへの貢献

このガイドは、Claude Code開発用スターターキットプロジェクトへの貢献方法を説明します。このプロジェクトは、AIエージェント（Claude、Cursor等）が効率的にプロジェクト開発を行えるよう、テンプレートとガイドラインを提供することを目的としています。
