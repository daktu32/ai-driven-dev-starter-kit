...
e2e-test-cli-rustのドキュメント体系を可視化し、各ドキュメントの役割と相互関係を明確にします。
...
graph TB
    ...
    subgraph "🏗️ 設計層"
        ...
        FEAT[FEATURE-SPEC.md<br/>📝 機能仕様書<br/>・[YOUR_MVP_FEATURES] <!-- 例: 基本コマンド、ヘルプ、エラー処理 --><br/>・コア・拡張機能<br/>・実装仕様]
...
- **目的**: 技術選定の理由と詳細
- **内容**:
  - 選定技術一覧（Frontend: Terminal UI, Backend: Rust, Database: SQLite）
  - 選定理由
  - バージョン情報
  - 依存関係
