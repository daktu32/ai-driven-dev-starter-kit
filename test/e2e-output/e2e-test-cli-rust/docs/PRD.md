...
### 1.2 目的・ミッション
[YOUR_PROJECT_PURPOSE] <!-- 例: コマンドライン業務の効率化・自動化 -->

### 1.3 スコープ
- **対象範囲**: [YOUR_TARGET_SCOPE] <!-- 例: ファイル処理、データ変換、システム管理タスク -->
- **対象外**: [YOUR_OUT_OF_SCOPE] <!-- 例: GUI アプリケーション、Webサービス -->
- **利用者**: [YOUR_TARGET_USERS] <!-- 例: 開発者、システム管理者、DevOpsエンジニア -->

## 2. ビジネス要求

### 2.1 ビジネス目標
- [YOUR_PRIMARY_GOAL] <!-- 例: 作業時間の短縮・品質向上 -->
...
#### 3.1.1 [YOUR_MVP_FEATURE_1] <!-- 例: コマンド実行 --> ([Issue #1] <!-- GitHubイシュー番号 -->)
...
#### 3.1.2 [YOUR_MVP_FEATURE_2] <!-- 例: ファイル操作 --> ([Issue #2] <!-- GitHubイシュー番号 -->)
